  ...
  return (
    <header className="z-[999] relative">
      ...
      {/*  fixed: Positions element relative to the viewport
        left-1/2: Places left edge at 50% of parent width
-translate-x-1/2: Shifts element left by 50% of its own width */}
          ...
          {links.map((link) => (
            ...
            >
              <Link
                ...
                hover:text-gray-950 transition dark:text-gray-400 dark:hover:text-gray-300"
                href={link.hash}
              >
                {link.name}
              </Link>
