...
export const experiencesData = [
  ...
  {
    title: "Software Developer — RoboNotts",
    location: "Nottingham, United Kingdom, Nov 2024 – June 2025",
    description:
      "Collaborated with Computer Science and Engineering students and academic staff on the research and development of Happy, a healthcare-focused robot. Contributed to software development and system integration, working across interdisciplinary teams to advance the robot's capabilities for healthcare applications.",
    icon: React.createElement(CgWorkAlt),
  },
  {
    title: "Technical Lead — UoN Women in Computer Science",
    location: "University of Nottingham, United Kingdom, Nov 2024 – June 2025",
    description:
      "Led planning and execution of technical workshops, hackathons, and coding sessions, fostering continuous learning and engagement within the society. Ensured events aligned with industry technologies and supported members' technical development through guidance and resources.",
    icon: React.createElement(CgWorkAlt),
  },
  {
    title: "KUMON Tutor",
...
export const educationData = [
  ...
  },
  {
    ...
    notes:
      "Selected among top 5 students from Malaysia for a one-year academic exchange.\n\n Second Year Grade: First Class Honours \nRelevant modules: Software Engineering Group Project, Introduction to Image Processing.",
  },
  {
    ...
    notes:
      "Grade: CGPA 4.0 \nRelevant modules: Object Oriented Programming, Data Structures and Software Design, Web Development and Databases.",
  },
  {
    institution: "St Joseph’s Private School, Kuching",
...
export const categorizedSkills = {
  languages: {
    title: "Languages",
    icon: "🌐",
    skills: ["English (Fluent)", "Malay (Conversational)", "Mandarin (Native)"],
  },
  softSkills: {
    title: "Soft Skills",
    icon: "💡",
